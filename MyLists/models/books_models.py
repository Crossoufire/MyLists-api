...
class BooksGenre(db.Model):
    ...
    @classmethod
    def replace_genres(cls, genres: List, media_id: int):
        ...
        # Add new genres
        db.session.add_all([cls(media_id=media_id, genre=genre) for genre in genres])
